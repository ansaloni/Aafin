...
interface EditBudgetModalProps {
  ...
  onClose: () => void;
  budget: Budget | null;
  onUpdate: (id: string, updated: Omit<Budget, "id" | "spent">) => void;
}
...
export function EditBudgetModal({ open, onClose, budget, onUpdate }: EditBudgetModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="Editar Orçamento">
